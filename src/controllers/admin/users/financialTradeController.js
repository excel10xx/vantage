...
const updateUserBalance = async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({ status: 'success', message: 'User balance updated successfully', data: user });
    } catch (error) {
...
const updateDepositTransaction = async (req, res) => {
    ...
    try {
        ...
        if (!deposit) {
            return res.status(404).json({ status: 'fail', message: 'Deposit transaction not found' });
        }
        ...
        res.status(200).json({ status: 'success', message: 'Deposit transaction updated successfully', data: deposit });
    } catch (error) {
...
const updateWithdrawalTransaction = async (req, res) => {
    ...
    try {
        ...
        if (!transaction || transaction.type !== 'withdraw') {
            return res.status(404).json({ status: 'fail', message: 'Withdrawal transaction not found' });
        }
        ...
        res.status(200).json({ status: 'success', message: 'Withdrawal transaction updated successfully', data: transaction });
    } catch (error) {
        res.status(500).json({ status: 'error', message: 'Server error', error: error.message });
    }
};
...
const updateTradeHistory = async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({ status: 'success', message: 'Trade history updated successfully', data: trade });
    } catch (error) {
        res.status(500).json({ status: 'error', message: 'Server error', error: error.message });
    }
};
...
const updateCopyTradingPortfolio = async (req, res) => {
    ...
    try {
        ...
        if (!portfolio) {
            return res.status(404).json({ status: 'fail', message: 'Copy trading portfolio not found' });
        }
        ...
        res.status(200).json({ status: 'success', message: 'Copy trading portfolio updated successfully', data: portfolio });
    } catch (error) {
        res.status(500).json({ status: 'error', message: 'Server error', error: error.message });
    }
};
